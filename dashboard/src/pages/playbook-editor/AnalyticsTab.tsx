export function AnalyticsTab() {
    return (
        <div className="text-center py-24 px-8 bg-[var(--bg-surface)] rounded-xl border border-[var(--border)]">
            ...
            <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-3">Analytics dashboard coming in Phase 9</h3>
